    ...
    <div ref={ref} className="relative">
      ...
      {show && (
        <div
          ...
          className="absolute right-0 mt-1 w-40 origin-top-right z-20 border-2 border-border bg-popover py-1 mc-panel fill-mode-forwards data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95"
        >
          {OPTIONS.map(o => (
            <button
              key={o.value}
